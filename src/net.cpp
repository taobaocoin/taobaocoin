...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "taobaocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"taobaocointools.com", "dnsseed.taobaocointools.com"},
    {"taobaocoinpool.org", "dnsseed.taobaocoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"taobaocointools.com", "testnet-seed.taobaocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. taobaocoin is probably already running."), addrBind.ToString().c_str());
        else
